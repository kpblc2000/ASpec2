namespace ASpecCore.Models.Data
{
    ...
    public partial class View_РазницаПараметров5
    {
        ...
        [Column("Площадь 1С")]
        public float? Площадь_1С { get; set; }
        ...
        public int? Габ_толщина_1С { get; set; }
