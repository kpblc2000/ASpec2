namespace ASpecCore.Models.Data
{
    ...
    public partial class v_ind_rods_fix
    {
        [Key]
        [Column(Order = 0)]
        ...
        [Column(Order = 1)]
        [StringLength(200)]
        public string ОСф { get; set; }

        [StringLength(250)]
        public string ОСф_блок_на_чертеже { get; set; }

        public bool? актуальность_ОСф { get; set; }
        ...
        public int? id_типа_ОСф { get; set; }

        [StringLength(50)]
        public string Тип_ОСф { get; set; }
