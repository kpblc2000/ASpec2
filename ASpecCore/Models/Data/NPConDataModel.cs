...
namespace ASpecCore.Models.Data
{
    public partial class NPConDataModel : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<p_object>()
                .HasMany(e => e.RCP_nomenclature)
                .WithRequired(e => e.p_object)
                .HasForeignKey(e => e.id_obj)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<Parameter1>()
                .HasMany(e => e.nomenclature_current)
            ...
            modelBuilder.Entity<Colour_article>()
                .HasMany(e => e.RCP_consistancy)
                .WithRequired(e => e.Colour_article)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<Colour_index>()
                .HasMany(e => e.RCP_nomenclature)
                .WithRequired(e => e.Colour_index)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<RCP_consistancy>()
                .Property(e => e.square_cons)
                .HasPrecision(10, 4);

            modelBuilder.Entity<RCP_nomenclature>()
                .HasMany(e => e.RCP_consistancy)
                .WithRequired(e => e.RCP_nomenclature)
                .WillCascadeOnDelete(false);
