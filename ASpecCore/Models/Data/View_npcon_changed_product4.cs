namespace ASpecCore.Models.Data
{
    ...
    public partial class View_npcon_changed_product4
    {
        [Key]
        [Column(Order = 0)]
        ...
        public decimal? ОбъемВнутреннегоСлоя_спец { get; set; }
        ...
        [Column("ID_ТорецВерх(зуб)")]
        public int? ID_ТорецВерх_зуб_ { get; set; }

        [Column("ОбъемТорецВерх(зуб)")]
        public decimal? ОбъемТорецВерх_зуб_ { get; set; }
